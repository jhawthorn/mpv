...
typedef struct vf_instance {
    ...
    int (*reconfig)(struct vf_instance *vf, struct mp_image *prototype,
                    int flags);
...
int vf_next_reconfig(struct vf_instance *vf, struct mp_image *prototype,
                     int flags);
...
int vf_reconfig_wrapper(struct vf_instance *vf, struct mp_image *prototype,
                        int flags);
